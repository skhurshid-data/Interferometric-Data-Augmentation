...
close all
clc
Array=csvread('E:\codes\DATA06.CSV');
col2 = Array(:, 2);
...
ymaxlim = ymaxlim + 60 * (ymaxlim/100);
yminlim = yminlim + 60 * (yminlim/100);
figure
%figure('position', [200 150 600 500]);
z = plot(col2, 'Linewidth',1);
f = gca;
xlabel('Time (s)');
ylabel('Amp. (au)');
f.FontWeight = 'bold';
...
%%axis([-1 -0.98 -0.02 0.02])
        ...
        name_experimental = ['Exp_signal_06_ ',num2str(i+j-1),'.png'];
