...
input_path = "/home/reserved/Sumair/concatenation/hori_con/hori_Input_images"
output_path = "/home/reserved/Sumair/concatenation/hori_con/hori_output_images"
dict_path = "/home/reserved/Sumair/concatenation/hori_con"
...
for w in window:
    ...
    for x in range(0,len(images),1):
        for y in range(0,len(images),1):
            if w == 2:
                ...
                width = int(image_1.shape[1] * scale_percent)
                height = int(image_1.shape[0])
                dim = (width, height)
                ...
                h_img = cv2.hconcat([image_1_resized, image_2_resized])
                output_image_name = 'image_' + str(index) + '.png'
                output_image_path = os.path.join(output_path, output_image_name)
                cv2.imwrite(output_image_path, h_img)
                ...
                h_img = cv2.hconcat([image_1_resized, image_2_resized, image_3_resized])
                output_image_name = 'image_' + str(index) + '.png'
                output_image_path = os.path.join(output_path, output_image_name)
                cv2.imwrite(output_image_path, h_img)
            ...
            # elif w == 4:
                ...
                # h_img = cv2.hconcat([image_1_resized, image_2_resized, image_3_resized, image_4_resized])
                # output_image_name = 'image_' + str(index) + '.png'
                # output_image_path = os.path.join(output_path, output_image_name)
                # cv2.imwrite(output_image_path, h_img)
 ...
 #               h_img = cv2.hconcat([image_1_resized, image_2_resized, image_3_resized, image_4_resized, image_5_resized])
 #               output_image_name = 'image_' + str(index) + '.png'
#
 #               output_image_path = os.path.join(output_path, output_image_name)
 #               cv2.imwrite(output_image_path, h_img)
